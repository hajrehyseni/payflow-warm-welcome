            ...
            <section className="rounded-3xl bg-card p-5 sm:p-6 ring-1 ring-border">
              ...
              <div className="mt-5 h-48 w-full">
                <svg viewBox="0 0 300 140" className="h-full w-full" preserveAspectRatio="none">
                  ...
                  {/* Area fill */}
                  <path
                    d="M0,20 C40,30 60,25 90,45 C120,75 140,55 170,85 C200,115 230,95 260,120 C280,135 300,125 300,125 L300,140 L0,140 Z"
                    className="fill-primary/10"
                  />
                  {/* Line */}
                  <path
                    d="M0,20 C40,30 60,25 90,45 C120,75 140,55 170,85 C200,115 230,95 260,120 C280,135 300,125 300,125"
                    fill="none"
